...
**Reviewed:Danny Kings** *(pod mate's name)*
**Link to my review:**
https://github.com/DannyKin/media-tracker-android/pull/2#pullrequestreview-4386199383

### What I Looked At
All of the issues in class and fixes applied.
<!-- Walk through the code you reviewed. What was the PR trying to do? Which files or
     functions did you focus on? -->

### What I Noticed
Didnt notice any specific bugs seemed top follow along
...
### Comments I Left
Said he did a good job following along
...
I am mainly confused on kotlin as a whole. But I plan on going back through everything done today to review.
...
Pod still is a little confused on github. Some forgot to make weekly branch. I plan on starting next group session with helping them set that up.
